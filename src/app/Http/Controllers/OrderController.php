...
class OrderController extends Controller
{
    ...
    public function store(Request $request)
    {
        $this->validate($request, [
            'data.attributes.costumer_id' => 'required|exists:costumers,id' // Changed customers_id to customer_id
        ]);
        
        $order = new Order();
        $order->costumer_id = $request->input('data.attributes.costumer_id'); // Changed customers_id to customer_id
    ...
    {
        $this->validate($request, [
            'data.attributes.costumer_id' => 'required|exists:costumers,id'
        ]);
        
        $order = Order::find($id);
        if ($order) {
            $order->costumer_id = $request->input('data.attributes.costumer_id');
